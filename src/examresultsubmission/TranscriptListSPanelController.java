 ...
 */
public class TranscriptListSPanelController implements Initializable {

    @FXML
    private AnchorPane TranscriptListSPanelpane;
    @FXML
    ...
    private void goBack(ActionEvent event) throws IOException 
    {
        ...
        TranscriptListSPanelpane.getChildren().setAll(root1);
    }
