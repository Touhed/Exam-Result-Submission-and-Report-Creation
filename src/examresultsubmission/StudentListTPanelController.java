 ...
 */
public class StudentListTPanelController implements Initializable {

    @FXML
    private AnchorPane StudentListTPanelPane;
    @FXML
    ...
    private void goBack(ActionEvent event) throws IOException 
    {
        ...
        StudentListTPanelPane.getChildren().setAll(root1);
    }
